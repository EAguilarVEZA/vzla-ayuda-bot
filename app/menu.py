...
SECTIONS = [
    ...
    {"key": "hero",
     ...
     "rows": [
         {"id": "8", "quick": True,
          "title": {"es": "Necesito o doy ayuda", "en": "Need or give help"},
          "desc": {"es": "Te conectamos", "en": "Get matched"}},
         {"id": "9", "quick": True,
          "title": {"es": "Ver solicitudes", "en": "See requests"},
          "desc": {"es": "Explora la red", "en": "Browse the board"}},
     ]},
    {"key": "safe",
...
_HEADERS = {
    ...
    "footer": {
        "es": "COMPARTIR · REPORTAR · ALERTAS de sismo · IDIOMA · BORRAR.",
        "en": "SHARE · REPORT · quake ALERTS · LANGUAGE · DELETE.",
    },
